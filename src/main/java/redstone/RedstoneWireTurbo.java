    ...
    */
    ...
    private void identifyNode(final World worldIn, final UpdateNode upd1) {
        ...
        if (!wire.canPlaceAt(null, worldIn, pos)) {
            ...
            Block.dropStack(worldIn, pos, new ItemStack(Items.REDSTONE)); // TODO
            worldIn.removeBlock(pos, false); // setAir
    ...
    private void updateNode(final World worldIn, final UpdateNode upd1, final int layer) {
        ...
        if (old_current_change) {
            newState = ((IRedstoneWireBlock)wire).calculateCurrentChanges(worldIn, pos, pos, oldState);
        } else {
    ...
    public BlockState updateSurroundingRedstone(final World worldIn, final BlockPos pos, final BlockState state, final BlockPos source) {
        ...
        final BlockState newState = ((IRedstoneWireBlock)wire).calculateCurrentChanges(worldIn, pos, pos, state);
    ...
    private BlockState calculateCurrentChanges(final World worldIn, final UpdateNode upd) {
        ...
        ((IRedstoneWireBlock)wire).paper_setCanProvidePower(false);
        ...
        ((IRedstoneWireBlock)wire).paper_setCanProvidePower(true);
        ...
        if (i != j) {
            ...
            if (wire.canPlaceAt(null, worldIn, pos)) {
                state = state.with(RedstoneWireBlock.POWER, Integer.valueOf(j));
